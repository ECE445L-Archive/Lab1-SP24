...
void ST7735_sDecOut2(int32_t n){
  ...
  if(n < -9999){
    ST7735_OutString(" -**.**");  // output -**.** to display
    return;
  }else if(n > 9999){
    ST7735_OutString("  **.**");  // output **.** to display
    return;
    ...
    if(n < 0){                    // if number is negative
      ...
      if(t < 100){                // if t is greater than -1,
        ST7735_OutString(" -0."); // print leading space then -0.
      }else if(t < 1000){         // if t is between -1 and -10,
        ST7735_OutString(" -");   // print a leading space and minus sign,
        ST7735_OutUDec(t/100);    // then the first two digits
        ST7735_OutString(".");
      }else{                      // if t is between -99 and -1,
        ST7735_OutString("-");    // print a minus sign
        ST7735_OutUDec(t/100);    // then the first two digits
        ST7735_OutString(".");
      }
    }else{
      if(t < 100){                // if t is less than 1,
        ST7735_OutString("  0."); // print leading spaces then 0.
      }else if(t < 1000){         // if t is between 1 and 10,
        ST7735_OutString("  ");   // print leading spaces
        ST7735_OutUDec(t/100);    // then the first two digits
        ST7735_OutString(".");
      }else{                      // if t is between 10 and 99,
        ST7735_OutString(" ");    // print leading space
        ST7735_OutUDec(t/100);    // then the first two digits
        ST7735_OutString(".");
      }
    }
    if((t%100) < 10){        // if remaining number is less than 0.1,
      ST7735_OutString("0"); // print 0 then the digit
      ST7735_OutUDec(t%100);
    }else{                   // if remaining number is between 0.1 and 1,
      ST7735_OutUDec(t%100); // print the remaining two digits
    }
    return;
  }
}
  ...
  if(n >= 64000){ // if input is greater than 63999    
    ...
    return;
      ...
      if((t%100) < 10){            // if remaining number is less than 0.1,
        ...
        ST7735_OutUDec(t%100);     // then print out remaining two digits
      }
    return;    
  }
} 
